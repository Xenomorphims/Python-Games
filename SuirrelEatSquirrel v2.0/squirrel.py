"""Name: SquirreleatSquirrel
   Python ver: 3.2 or 2.x
   Author: Innocent M Sakala
   Alias: Xenorm
   Start: 5/10/16 #Finish: 04/01/17
...
def main():
    ...
    L_SQUIR_IMG = pygame.image.load('ghost.png')
    R_SQUIR_IMG = pygame.transform.flip(L_SQUIR_IMG, True, False)
    GRASSIMAGES = []
    for i in range(1, 5):
        GRASSIMAGES.append(pygame.image.load('cross%s.png' % i))
...
def runGame():
    ...
    winSurf = BASICFONT.render('You have achieved OMEGA SQUIRREL!', True, RED)
